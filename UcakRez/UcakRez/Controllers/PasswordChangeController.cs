...
namespace UcakRez.Controllers
{
    ...
    public class PasswordChangeController : Controller
    {
        ...
        public async Task<IActionResult> ForgetPassword(ForgetPasswordViewModel forgetPasswordViewModel)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("Admin", "yenitelefonla5@gmail.com");
            ...
            mimeMessage.Subject = "Şifre değişme isteği";

            SmtpClient client = new SmtpClient();
            client.Connect("smtp.gmail.com", 587, false);
            client.Authenticate("yenitelefonla5@gmail.com", "expdpavobuikqovn");
